...
const projectsData = [
  {
    ...
    description: "Full-stack cybersecurity platform integrating malware scanning, phishing detection, IP/DNS analysis, breach monitoring, secure password management, and an AI cybersecurity assistant.",
    tags: ["React", "Node.js", "MongoDB", "Firebase Auth", "VirusTotal API"],
    match: "100%",
    episode: "S01 E01"
  },
  {
    ...
    description: "Modern music streaming web app with synchronized lyrics, crossfade engine, waveform visualization, EQ controls, queue management, and a glassmorphism-based interface.",
    tags: ["React", "Node.js", "MongoDB", "Web Audio API", "Zustand"],
    match: "99%",
    episode: "S01 E02"
  },
  {
    ...
    description: "Intelligent conversational assistant embedded in CyberSafeHub, specialized in cybersecurity guidance, threat analysis, and security best practices using LLM workflows.",
    tags: ["Python", "Node.js", "NLP", "REST APIs", "MongoDB"],
    match: "97%",
    episode: "S01 E03"
  },
  {
    ...
    description: "Automated data-breach monitoring system integrating Have I Been Pwned (HIBP) API with real-time alerts and AES-256 encrypted password vault management.",
    tags: ["Node.js", "AES-256", "HIBP API", "Express", "MongoDB"],
    match: "98%",
    episode: "S01 E04"
  },
  {
    title: "Malware & Phishing Scanner",
    category: "Threat Detection",
    description: "Multi-engine threat analysis system combining ClamAV antivirus and VirusTotal API for URL, file, and domain scanning with detailed threat reporting.",
    tags: ["ClamAV", "VirusTotal", "Node.js", "Express", "React"],
    match: "96%",
    episode: "S01 E05"
  },
  {
    title: "Auralis Music Engine",
    category: "Audio Engineering",
    description: "Custom HTML5 + Web Audio API music engine with track preloading, crossfade transitions, EQ, and smooth playback optimized for low-bandwidth connections.",
    tags: ["Web Audio API", "JavaScript", "HTML5 Audio", "React", "Zustand"],
    match: "99%",
    episode: "S01 E06"
  },
  {
    title: "Portfolio Cinematics v1.0",
    category: "UI/UX & Animation",
    description: "Netflix-inspired dark studio interactive portfolio featuring GSAP cinematic physics, 3D card interactions, and responsive layouts.",
  ...
  },
  {
    ...
    description: "Production-grade Firebase Authentication pipeline powering CyberSafeHub with secure sign-in, session management, and role-based access control.",
    tags: ["Firebase", "Node.js", "React", "Express", "JWT"],
    match: "98%",
    episode: "S01 E08"
  }
];
...
const Projects = () => {
  ...
  useEffect(() => {
    // Data loads asynchronously from the API — don't run until cards exist
    if (!projectsData || projectsData.length === 0) return;

    // DO NOT clear ref arrays here — React populates them before useEffect runs.
    // Clearing them would leave GSAP with no card elements to animate.
    ...
    // Recalculate scroll positions — content just changed page layout
  ...
  return (
    <section id="projects" ref={containerRef} className="bg-[#0b0b0b] min-h-screen md:min-h-[170vh] relative font-sans overflow-x-clip text-white w-full flex items-center justify-center py-16 md:py-40 select-none">
      ...
      {/* Main Perspective Container \u2014 desktop only, mobile uses the carousel below */}
      ...
      {/* Mobile Swipeable Carousel — positioned in normal flow, not absolute, so it doesn't overlap folder */}
      <div 
        ref={mobileCarouselRef}
        className="md:hidden w-full py-8 flex items-center gap-5 px-[6vw] pointer-events-none z-[100] snap-x snap-mandatory overflow-x-hidden hide-scrollbar relative"
      >
        <style>{`
        ...
        {projectsData.map((project, i) => (
          <div 
            ...
            className="shrink-0 w-[82vw] aspect-[4/3] snap-center will-change-transform relative z-10"
          >
