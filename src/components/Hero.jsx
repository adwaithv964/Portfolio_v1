...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 h-full flex flex-col justify-between pt-20 md:pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-white/80">{h.seasons}</span>
          </div>
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">{h.badgeLeft}</span>
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">{h.badgeRight}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              <span className="px-2.5 py-0.5 bg-red-600 text-white font-black text-xs rounded tracking-widest shadow-[0_0_20px_rgba(229,9,20,0.8)] animate-pulse">{h.topBadge}</span>
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">{h.roleTagline}</span>
            </div>

            <h1 className="hero-anim-item text-4xl md:text-7xl font-black tracking-tighter text-white leading-[0.95] drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]">
              {h.name} <br />
            ...
            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-red-400 font-bold">
              ...
              <span className="text-white/40">•</span>
              <span>{ h.techStack }</span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">{h.techBadge}</span>
            </div>
          ...
          <div className="lg:col-span-4 flex justify-center perspective-[1200px]">
            ...
            >
              ...
              <div className="relative w-[220px] md:w-[320px] p-3.5 bg-[#141414]/90 backdrop-blur-2xl rounded-2xl border border-red-600/40 shadow-[0_40px_80px_rgba(0,0,0,0.95)] overflow-hidden">
          ...
          {/* Right Side: Technical Specs — hidden on mobile, visible from lg */}
          <div className="hero-anim-item hidden lg:flex lg:col-span-3 flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold mb-2">Core Stack & Highlights</h3>
      ...
      <header className="absolute top-0 left-0 z-50 w-full max-w-7xl mx-auto px-6 md:px-12 py-6 flex items-center justify-between pointer-events-auto">
        <div className="text-2xl font-black text-red-600 tracking-tighter flex items-center gap-2 drop-shadow-[0_2px_15px_rgba(229,9,20,0.9)]">
          {h.name}<span className="w-1.5 h-1.5 rounded-full bg-white inline-block"></span>
        </div>
